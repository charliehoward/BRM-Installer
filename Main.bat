...
MODE 120,30
SET "cmdwidth=120"
cURL -o "C:\Windows\BRM Computers\OEM.bmp" "https://raw.githubusercontent.com/charliehoward/BRM-Installer/master/Assets/OEM.bmp" --insecure
cURL -o "C:\Windows\BRM Computers\SetTaskbar.vbs" "https://raw.githubusercontent.com/charliehoward/BRM-Installer/master/Assets/SetTaskbar.vbs" --insecure
cURL -o "C:\Windows\BRM Computers\PinTo10.exe" "https://raw.githubusercontent.com/charliehoward/BRM-Installer/master/Assets/PinTo10.exe" --insecure
cURL -o "C:\Windows\BRM Computers\Clean.bat" "https://raw.githubusercontent.com/charliehoward/BRM-Installer/master/Clean.bat" --insecure
@ECHO.
@ECHO.
@ECHO.
@ECHO.
...
@ECHO.
@ECHO.
@ECHO. BRM Installer   v3.2.0.0   2017-02-07
@ECHO. Powered by Chocolatey
@ECHO.
@ECHO.				------------------------------------------------------
@ECHO.						BRM Installer 3.2.0.0
@ECHO. 				------------------------------------------------------
@ECHO.
@ECHO.
@ECHO.
...
"C:\Windows\BRM Computers\Clean.bat"
