...
cURL -o "C:\Windows\BRM Computers\kaspersky17.nupkg" "https://raw.githubusercontent.com/TheJumpyWizard/BRM-Installer/master/kaspersky17.nupkg" --insecure
...
CHOCO install "C:\Windows\BRM Computers\kaspersky17.nupkg" --confirm --allow-empty-checksums
